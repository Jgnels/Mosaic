...
PROTOCOL_ID = "MOSAIC_RELATIONSHIP_BALANCE_PILOT_V2"
...
def build_request(subject: str, character: str, counterpart: str, evidence: list[dict]) -> dict:
    ...
    prompt = (
        ...
        "Never invent facts, motives, intentions, private feelings, or personality traits. Describe only supplied events and the character's present trust/caution assessment. Use MIXED when substantial evidence supports both trust and caution. Keep the answer non-manipulative and under 240 characters. Return JSON only.\nSCHEMA:\n"
