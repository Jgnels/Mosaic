[CmdletBinding()]
param(
    [ValidateSet("HARDENED_PROVIDER_SMOKE_V1", "MOSAIC_MEMORY_GROUNDING_PILOT_V1", "MOSAIC_RELATIONSHIP_BALANCE_PILOT_V1", "MOSAIC_RELATIONSHIP_BALANCE_PILOT_V2")]
...
Invoke-WithDagmayGeminiCredential -ScriptBlock {
    if ($Protocol -eq "MOSAIC_RELATIONSHIP_BALANCE_PILOT_V2") {
